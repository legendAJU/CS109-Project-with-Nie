...
public class LeopardChessComponent extends JComponent {
    ...
    protected void paintComponent(Graphics g) {
        ...
        if(owner == PlayerColor.BLUE){
            icon = new ImageIcon("E:\\OneDrive - 南方科技大学\\桌面\\大一下\\cs\\斗兽棋\\resource\\LeopardInBlue.png");
        }else if(owner == PlayerColor.RED){
            icon = new ImageIcon("E:\\OneDrive - 南方科技大学\\桌面\\大一下\\cs\\斗兽棋\\resource\\LeopardInRed.png");
        }
